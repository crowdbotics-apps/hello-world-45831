"""
Django settings for hello_world_45831 project.
...
ROOT_URLCONF = 'hello_world_45831.urls'
...
WSGI_APPLICATION = 'hello_world_45831.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hello_world_45831 API",
    "DESCRIPTION": "API documentation for hello_world_45831 App",
    "VERSION": "v1",
}
